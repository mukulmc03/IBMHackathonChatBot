...
<br/><br/><br/><br/>
	...
	<div class="col-sm-2"></div>
		...
		<div class="col-sm-2"></div>
			...
			<form>
			<h1 style="font-family:Times New Roman;color:#ffffff;"><center>Update Words</center></h1>
...
<td><a href="Question_Update_Process.jsp?uid=<%=rs.getString("uid")%>">
